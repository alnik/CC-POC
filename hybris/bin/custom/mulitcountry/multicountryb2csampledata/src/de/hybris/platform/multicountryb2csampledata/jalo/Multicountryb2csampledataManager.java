 ...
 */
package de.hybris.platform.multicountryb2csampledata.jalo;
...
import de.hybris.platform.multicountryb2csampledata.constants.Multicountryb2csampledataConstants;



/**
 * This is the extension manager of the Multicountryb2csampledata extension.
 */
public class Multicountryb2csampledataManager extends GeneratedMulticountryb2csampledataManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Multicountryb2csampledataManager.class);
	 ...
	 */
	public static Multicountryb2csampledataManager getInstance()
	{
		return (Multicountryb2csampledataManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Multicountryb2csampledataConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Multicountryb2csampledataManager() // NOPMD 
	{
		LOG.debug("constructor of Multicountryb2csampledataManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Multicountryb2csampledataManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Multicountryb2csampledataManager called, current tenant: {}", getTenant().getTenantID());
	}
