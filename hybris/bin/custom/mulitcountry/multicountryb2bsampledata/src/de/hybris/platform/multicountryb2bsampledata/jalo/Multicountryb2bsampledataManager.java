 ...
 */
package de.hybris.platform.multicountryb2bsampledata.jalo;
...
/**
 * This is the extension manager of the Multicountryb2bsampledata extension.
 */
public class Multicountryb2bsampledataManager extends GeneratedMulticountryb2bsampledataManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Multicountryb2bsampledataManager.class);
	 ...
	 */
	public static Multicountryb2bsampledataManager getInstance()
	{
		return (Multicountryb2bsampledataManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Multicountryb2bsampledataConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Multicountryb2bsampledataManager() // NOPMD
	{
		LOG.debug("constructor of Multicountryb2bsampledataManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Multicountryb2bsampledataManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Multicountryb2bsampledataManager called, current tenant: {}", getTenant().getTenantID());
	}
