...
@ManualTest
@Unroll
class SparAddressTest extends AbstractUserTest {
	...
	def "Customer creates address when request: #requestFormat and response: #responseFormat"() {
		...
		HttpResponseDecorator response = restClient.post(
				...
				requestContentType: requestFormat) as HttpResponseDecorator
	...
	def "Customer gets single address with cellphone and district: #format"() {
		...
		HttpResponseDecorator response = restClient.get(
				...
				contentType: format,
				requestContentType: ContentType.URLENC) as HttpResponseDecorator
